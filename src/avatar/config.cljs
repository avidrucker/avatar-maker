...
(def presets
  [(assoc default-spec :preset-id "d3895417-5934-43ff-8896-291af00437de")
   {:version 16
    :preset-id "c8ea26d4-45e4-4227-b4cd-f6be12b1276f"
    :name-id "Matsura"
    :parts
   ...
   {:version 16
    :preset-id "fc573885-ba53-44a7-855d-2417e5e6304c"
    :name-id "Kendra"
    :parts
