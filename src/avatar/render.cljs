...
(def hair-003
  (make-hair
   {:back
    ...
    :front
    "M19.5 68L34.5 15.5L50.5 19L65.5 15.5L76 44.5L80.5 68L79.5 77L75 78.5L70 69.5L68.5 50L65.5 34L59 21.5H41L32 34L31 63.5L29.5 70L25 78.5L20.5 77L19.5 68Z"
    :front2
    "M34 52L30.5 53.5L26 47.5L38.5 14.5L50.5 18.5L62.5 14.5L74 49L68.5 53.5L65.5 52L58 25.5L50.5 24L42.5 25.5L34 52Z"}))

(def hair-004
  (make-hair
   {:back
    "M24 60C24.1421 48.9809 24.3971 43.0264 26.5 34.5H73.5C75.5593 43.8746 75.9093 49.4186 76 59.5C82.0001 73 79.0001 81.5 72 89L69 82.5C57.5 91.5 42.5 91 31 82.5L28 89C20.5 81.5 19.0001 72.5 24 60Z"
    :front
    "M42 30C41 41 32.5 55 20.5 52.5C25 43.5 23 36.5 27 28C27 28 31.5 14 50 14C68.5 14 73.5 28 73.5 28C77.5 37 75 43 80 52.5C71.5 54 61.5 47 58 30C54.0694 28.8097 52.1735 28.0013 50 26C47.7622 28.0421 45.8642 28.8386 42 30Z"}))
